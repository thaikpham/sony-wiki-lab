    ...
    return (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M15.75 10.5l4.038-2.423A.75.75 0 0121 8.72v6.56a.75.75 0 01-1.212.643L15.75 13.5m-9 4.5h7.5A2.25 2.25 0 0016.5 15.75V8.25A2.25 2.25 0 0014.25 6h-7.5A2.25 2.25 0 004.5 8.25v7.5A2.25 2.25 0 006.75 18z"
        />
      </svg>
    );
  }
    ...
    return (
      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden="true">
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M6.75 7.5h10.5A2.25 2.25 0 0119.5 9.75v6.75a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 16.5V9.75A2.25 2.25 0 016.75 7.5z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M9 7.5l.74-1.48A1.5 1.5 0 0111.082 5.25h1.836a1.5 1.5 0 011.342.77L15 7.5M12 15.75a2.625 2.625 0 100-5.25 2.625 2.625 0 000 5.25z"
        />
      </svg>
    );
  }
